...
export function PedigreeDialog({ bird, open, onOpenChange }: PedigreeDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl rounded-3xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {language === "ar" ? bird.name : (bird as any).nameEn} - {bird.ringNumber}
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <TabsContent value="info" className="mt-4 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label className="text-muted-foreground">{t("ringNumber")}</Label>
                                    <p className="font-medium">{bird.ringNumber}</p>
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-muted-foreground">{t("pigeonName")}</Label>
                            ...
                            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                                ...
                                <Card className="rounded-2xl">
                                    <CardContent className="p-4 text-center">
                                        ...
                                        <p className="text-2xl font-bold">
                                            {Math.round(
                                                (((bird as any).wins || 0) / ((bird as any).races || 1)) *
                                                100,
                                            )}
                                            %
                                        </p>
