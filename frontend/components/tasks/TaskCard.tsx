...
import { Clock, Repeat, MoreHorizontal, Edit, ClipboardList, Trash } from "lucide-react";
...
interface TaskCardProps {
    task: Task;
    onToggleComplete: (taskId: string, currentStatus: string, dateStr: string) => void;
...
export function TaskCard({
    ...
    const getPriorityText = (priority: string) => {
        switch (priority) {
            case "high": return t("priorityHigh" as any);
            case "medium": return t("priorityMedium" as any);
            case "low": return t("priorityLow" as any);
            default: return "";
        }
    };
    ...
    return (
        ...
        >
            <Checkbox
                ...
                onCheckedChange={() => onToggleComplete(task.id, task.status, task.instanceDate)}
            ...
            <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge
                        variant="outline"
                        className={cn("rounded-xl text-xs", getPriorityColor(task.priority))}
                    >
            ...
            <div className="flex items-center gap-2">
                {task.status !== "completed" && (
                    <Button
                        ...
                        onClick={() => onToggleComplete(task.id, task.status, task.instanceDate)}
                    >
