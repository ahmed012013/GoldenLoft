    ...
    return (
        <div className="flex flex-col items-center text-center group">
            <div className="w-14 h-14 mb-4 rounded-2xl bg-primary-gold/10 border border-primary-gold/20 flex items-center justify-center group-hover:bg-primary-gold/20 transition-colors">
                <span className="material-icons text-primary-gold text-2xl">{stat.icon}</span>
            </div>
        ...
        <section id="stats" ref={sectionRef} className="py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-500 max-w-md mx-auto">Real numbers from real fanciers managing their lofts with GoldenLoft.</p>
                </div>
