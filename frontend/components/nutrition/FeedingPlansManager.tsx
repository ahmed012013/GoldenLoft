...
import { Utensils, Clock, CheckCircle2, Users, Search, Plus, Play, Pause, MoreHorizontal, Filter, Edit, Trash2 } from "lucide-react";
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">{t("totalFeedingPlans" as any)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">{t("activePlans" as any)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                <Card className="rounded-2xl">
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-2xl font-bold">{plans.reduce((sum, p) => sum + p.pigeonCount, 0)}</p>
                                <p className="text-xs text-muted-foreground">{t("pigeons" as any)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">{t("feedingFrequency" as any)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                        ...
                        <CardContent className="p-4">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="flex items-start gap-4">
                                    <div className={cn("flex h-12 w-12 items-center justify-center rounded-xl", plan.isActive ? "bg-green-500/10" : "bg-muted")}>
                                        <Utensils className={cn("h-6 w-6", plan.isActive ? "text-green-500" : "text-muted-foreground")} />
                                    </div>
                                    <div className="space-y-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Badge variant={plan.isActive ? "default" : "secondary"} className="rounded-full">
                                                {plan.isActive ? t("activePlan" as any) : t("inactivePlan" as any)}
                                            </Badge>
                                        </div>
                                        <p className="text-sm text-muted-foreground">
                                            {getTargetGroupLabel(plan.targetGroup)} - {plan.pigeonCount} {t("pigeons" as any)}
                                        </p>
                                ...
                                <div className="flex items-center gap-2">
                                    <Button variant="outline" size="sm" onClick={() => onToggleStatus(plan.id)} className="rounded-xl bg-transparent">
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align={dir === "rtl" ? "start" : "end"}>
                                            ...
                                            <DropdownMenuItem onClick={() => onDelete(plan.id)} className="text-red-500">
