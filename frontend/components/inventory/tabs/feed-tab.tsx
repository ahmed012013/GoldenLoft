...
import { AlertTriangle, DollarSign, Edit, Package, Plus, Search, Trash2, TrendingDown } from "lucide-react";
...
export function InventoryFeedTab({
    ...
    const stats = {
        ...
        outOfStock: items.filter((i) => getComputedStatus(i) === "outOfStock").length,
