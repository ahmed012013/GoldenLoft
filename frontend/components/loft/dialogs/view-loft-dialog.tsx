    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="rounded-3xl sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle>{t("loftDetails") || (language === "ar" ? "تفاصيل اللوفت" : "Loft Details")}</DialogTitle>
                    <DialogDescription>
                        {t("viewLoftDetailsDesc") || (language === "ar" ? "عرض التفاصيل الكاملة للوفت" : "View complete details of the loft")}
                    </DialogDescription>
                </DialogHeader>
                <div className="grid gap-6 py-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <Label className="text-muted-foreground">{t("loftLocation")}</Label>
                    ...
                    <div>
                        <Label className="text-muted-foreground">{t("loftDescription")}</Label>
